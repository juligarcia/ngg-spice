...
export const fixedTopClass =
  "!top-0 !left-[50%] !-translate-x-2/4 !-translate-y-2/4 !bottom-[unset] !right-[unset]";

export const fixedBottomClass =
  "!bottom-0 !left-[50%] !-translate-x-2/4 !translate-y-2/4 !top-[unset] !right-[unset]";
